...
public class CategoryCategoryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    public TextView txtCategoryName;
    public ImageView txtCategoryImage;
    public ItemClickListener listener;

    public CategoryCategoryViewHolder(@NonNull View itemView) {
        super(itemView);
